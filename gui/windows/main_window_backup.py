"""
Main Window - Simplified and Modular
Clean main window with delegated responsibilities
"""
...
class MainWindow(QMainWindow):
    """Enhanced main window - modular and simplified"""
